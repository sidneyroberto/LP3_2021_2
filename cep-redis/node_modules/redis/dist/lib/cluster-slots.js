...
class RedisClusterSlots {
    ...
    async discover(startWith) {
        var _a, _b;
        if (await __classPrivateFieldGet(this, _RedisClusterSlots_instances, "m", _RedisClusterSlots_discoverNodes).call(this, (_a = startWith.options) === null || _a === void 0 ? void 0 : _a.socket))
            return;
        for (const { client } of __classPrivateFieldGet(this, _RedisClusterSlots_nodeByUrl, "f").values()) {
            if (client === startWith)
                continue;
            if (await __classPrivateFieldGet(this, _RedisClusterSlots_instances, "m", _RedisClusterSlots_discoverNodes).call(this, (_b = client.options) === null || _b === void 0 ? void 0 : _b.socket))
                return;
        }
    ...
    getClient(firstKey, isReadonly) {
        ...
        const slot = (0, cluster_key_slot_1.default)(firstKey);
...
_RedisClusterSlots_options = new WeakMap(), _RedisClusterSlots_onError = new WeakMap(), _RedisClusterSlots_nodeByUrl = new WeakMap(), _RedisClusterSlots_slots = new WeakMap(), _RedisClusterSlots_randomClientIterator = new WeakMap(), _RedisClusterSlots_instances = new WeakSet(), _RedisClusterSlots_discoverNodes = async function _RedisClusterSlots_discoverNodes(socketOptions) {
