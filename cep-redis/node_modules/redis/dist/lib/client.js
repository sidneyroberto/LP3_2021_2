...
class RedisClient extends events_1.default {
    ...
    QUIT() {
        return __classPrivateFieldGet(this, _RedisClient_socket, "f").quit(() => {
            const promise = __classPrivateFieldGet(this, _RedisClient_queue, "f").addEncodedCommand((0, commander_1.encodeCommand)(['QUIT']));
...
_a = RedisClient, _RedisClient_options = new WeakMap(), _RedisClient_socket = new WeakMap(), _RedisClient_queue = new WeakMap(), _RedisClient_isolationPool = new WeakMap(), _RedisClient_v4 = new WeakMap(), _RedisClient_selectedDB = new WeakMap(), _RedisClient_isTickQueued = new WeakMap(), _RedisClient_instances = new WeakSet(), _RedisClient_scriptsExecutor = async function _RedisClient_scriptsExecutor(script, args) {
    ...
    const socketInitiator = async () => {
        ...
        if (((_e = (_d = __classPrivateFieldGet(this, _RedisClient_options, "f")) === null || _d === void 0 ? void 0 : _d.socket) === null || _e === void 0 ? void 0 : _e.username) || ((_g = (_f = __classPrivateFieldGet(this, _RedisClient_options, "f")) === null || _f === void 0 ? void 0 : _f.socket) === null || _g === void 0 ? void 0 : _g.password)) {
    ...
    return this.sendEncodedCommand((0, commander_1.encodeCommand)(args), options);
...
(0, commander_1.extendWithDefaultCommands)(RedisClient, RedisClient.commandsExecutor);
